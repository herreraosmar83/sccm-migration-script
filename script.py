...
connectionString = "DRIVER={ODBC Driver 17 for SQL Server};SERVER=%s;DATABASE=%s;UID=%s;PWD=%s"
query = """
...
"""
conn = pyodbc.connect(connectionString % (server,database,uid,password))
cursor = conn.cursor()
